...
void testConstructorTwoDataBytes()
{
    ...
    CMidiPacket mp2a{static_cast<uint32_t>(-1000), 0xA0, 127, 129}; // here's your false positive...
    CMidiPacket mp2b{1000, 0x70, 127};
}
...
void testStringConstructor()
{
    ...
    CMidiPacket mp4{"1000\n0xC0\n30\t120"};
    CMidiPacket mp5{"1000\t0xC0\n30\n120"};
    CMidiPacket mp6{"1000\t0xC0\t30     120"};
}
